...
import CollectionSuspensionList from '@/views/CollectionSuspensionList.vue'
...
const routes = [
  ...
  { path: '/collection-suspensions', name: 'CollectionSuspensionList', component: CollectionSuspensionList }
]
